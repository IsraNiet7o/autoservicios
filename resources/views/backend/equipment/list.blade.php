...
@section('content')
	<h1 class="page-header shadow-title ">Lista de Equipos </h1>
	
		<div class="row">
			<a class="btn btn-default" href="{!!route('technical.create') !!}" role="button"><i class="material-icons right">add</i>Administración	
			</a>
		</div>
